...
!(function (e) {
  ...
  var d = 'bippy-0.3.8',
    ...
    v = (e = k()) =>
      !!g ||
      ('function' == typeof e.inject && (w = e.inject.toString()),
      Boolean(w?.includes('(injected)'))),
    b = new Set(),
    x = (e) => {
      const t = new Map();
      let n = 0,
          ...
          inject(e) {
            ...
            return (
              ...
              r._instrumentationIsActive ||
                ((r._instrumentationIsActive = !0), b.forEach((e) => e())),
              o
            );
          },
    ...
    k = (e) =>
      p.call(globalThis, '__REACT_DEVTOOLS_GLOBAL_HOOK__')
        ? (y(e), globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__)
        : x(e),
    _ = (e) => {
      switch (e.tag) {
        case 5:
  ...
  (() => {
    try {
      Boolean(
        ...
        (window.document?.createElement || 'ReactNative' === window.navigator?.product)
      ) && k();
    } catch {}
  })();
  var H,
  ...
  function he(e, t, n) {
    ...
    if (
      (arguments.length > 2 && (a.children = arguments.length > 3 ? H.call(arguments, 2) : n),
  ...
  function be(e) {
    ((!e.__d && (e.__d = !0) && B.push(e) && !xe.__r++) || q !== Y.debounceRendering) &&
      ((q = Y.debounceRendering) || J)(xe);
  }
  function xe() {
    var e, t, n, r, o, i, a, s;
          ...
          null != (i = t[o]) && 'boolean' != typeof i && 'function' != typeof i
            ? ((s = o + p),
              ...
              null == a || null === a.__v
                ...
                : l !== s &&
                  (l == s - 1 ? p-- : l == s + 1 ? p++ : (l > s ? p-- : p++, (i.__u |= 4))))
            : (i = e.__k[o] = null);
        if (u)
          for (o = 0; o < d; o++)
            null != (a = n[o]) && !(2 & a.__u) && (a.__e == r && (r = we(a)), Me(a, a));
        return r;
      })(n, t, w, l),
        u = 0;
      u < v;
  ...
  function ke(e, t, n) {
    ...
    e.__e != t &&
      (t && e.type && !n.contains(t) && (t = we(e)), n.insertBefore(e.__e, t || null), (t = e.__e));
    do {
      t = t && t.nextSibling;
  ...
  function Se(e, t, n) {
    '-' === t[0]
      ...
      : (e[t] = null == n ? '' : 'number' != typeof n || ce.test(t) ? n : n + 'px');
  }
    ...
    e: if ('style' === t)
      ...
      ((i = t !== (t = t.replace(K, '$1'))),
        ...
        n
          ? r
            ? (n.u = r.u)
            : ((n.u = Z), e.addEventListener(t, i ? ee : Q, i))
          : e.removeEventListener(t, i ? ee : Q, i));
    else {
      ...
      try {
        if (
          ...
          n.__c
            ...
            : (v
                ? (t.__c = u = new T(w, x))
                : ((t.__c = u = new ge(w, x)), (u.constructor = T), (u.render = Fe)),
              b && b.sub(u),
              (u.props = w),
              u.state || (u.state = {}),
              (u.context = x),
          ...
          v &&
            ...
            ue(u.__s, T.getDerivedStateFromProps(w, u.__s))),
          (h = u.props),
          (m = u.state),
          (u.__v = t),
          p)
          ...
          if (
            ...
            !u.__e &&
              ((null != u.shouldComponentUpdate && !1 === u.shouldComponentUpdate(w, u.__s, x)) ||
                t.__v === n.__v))
          ) {
            for (
        ...
        ((u.state = u.__s),
          ...
          (s = ye(
            e,
            de((S = null != d && d.type === fe && null == d.key ? d.props.children : d)) ? S : [S],
            t,
            n,
            r,
            o,
        ...
        if (((t.__v = null), l || null != i))
          if (e.then) {
            for (t.__u |= l ? 160 : 128; s && 8 === s.nodeType && s.nextSibling; )
              s = s.nextSibling;
  ...
  function Me(e, t, n) {
    ...
    if (
      ...
      (r = e.ref) && ((r.current && r.current !== e.__e) || Ae(r, null, t)),
      null != (r = e.__c))
    ) {
    ...
    if ((r = e.__k))
      for (o = 0; o < r.length; o++) r[o] && Me(r[o], t, n || 'function' != typeof e.type);
  ...
  ((H = le.slice),
    ...
    (ge.prototype.setState = function (e, t) {
      var n;
      ((n =
        null != this.__s && this.__s !== this.state ? this.__s : (this.__s = ue({}, this.state))),
  ...
  ((De.__b = function (e) {
    ...
    (De.diffed = function (e) {
      ...
      (t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== je.push(t) && ie === De.requestAnimationFrame) ||
            ((ie = De.requestAnimationFrame) || et)(Ze)),
      ...
      return (
        (t.__$u.c = function () {
          var e,
            ...
            r = o.value;
          (n(),
            X(r) || 3 !== (null == (e = t.base) ? void 0 : e.nodeType)
              ? ((t.__$f |= 1), t.setState({}))
              : (t.base.data = r));
        }),
        yt(function () {
    ...
    yr = Vn(() => {
      ...
      return {
        ...
        classGroups: {
          ...
          'max-w': [
            {
              'max-w': [sr, t, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [lr] }, lr],
            },
          ],
          ...
          'bg-image': [
            { bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, hr] },
          ],
          'bg-color': [{ bg: [e] }],
          ...
          transition: [
            { transition: ['none', 'all', '', 'colors', 'opacity', 'shadow', 'transform', sr] },
          ],
          duration: [{ duration: A() }],
  ...
  var _r = (e, t) => {
    ...
    Tr = (e) => {
      ...
      if (
        (24 === t &&
          a.push({ type: 'lazy', title: 'Lazily loaded component that supports code splitting' }),
        13 === t &&
          a.push({
            type: 'suspense',
        ...
        12 === t &&
          a.push({ type: 'profiler', title: 'Component that measures rendering performance' }),
        'string' == typeof o)
      ) {
        const e = /^(\w+)\((.*)\)$/;
        let t = o;
      ...
      (() => {
        ...
        return e
          ...
          : (Sr(Cn, {
              ...
              lastDimensions: Ar.lastDimensions,
              componentsTree: Ar.componentsTree,
            }),
            Ar);
      })()
    ),
  ...
  var Dr = new WeakMap(),
          ...
          n =
            t instanceof HTMLElement
              ...
              : (() => {
                  ...
                  return (
                    this.activeFlashes.set(e, { element: e, overlay: t, scrollCleanup: n }),
                    t
                  );
                })(),
          r = Dr.get(n);
    ...
    Qr = ({
      ...
      const s = qe(null),
        ...
        { highlightedText: c, typeHighlight: d } = ((e, t) =>
          Je(() => {
            ...
            if (!n || !o)
              return {
                highlightedText: bn('span', { className: 'truncate', children: e.label }),
                typeHighlight: !1,
              };
            let s = !0;
            if (i.length > 0)
      ...
      Xe(() => {
        ...
        n &&
          ...
          t &&
          l.current !== t &&
          (n.classList.remove('count-flash'),
          n.offsetWidth,
          n.classList.add('count-flash'),
          (l.current = t));
          ...
          bn('button', {
            ...
            children:
              ...
              bn(xn, {
                ...
                size: 12,
                className: kr('transition-transform', !r && 'rotate-90'),
              }),
          }),
          c,
          p,
        ...
        S = Ge(
          (t) => {
            ...
            if (i.startsWith('/') && !a && i.length > 1)
              n.current?.classList.add('!border-red-500');
            else {
              if (a)
                try {
                  const e = i.slice(1, -1),
              ...
              if (
                ((Xr.value = { query: t, matches: r, currentMatchIndex: r.length > 0 ? 0 : -1 }),
                r.length > 0)
              ) {
                const t = r[0],
            ...
            const a = (e) => {
              ...
              l = () => {
                e.current &&
                  ...
                  (Mr.value = {
                    ...Mr.value,
                    componentsTree: { ...Mr.value.componentsTree, width: e.current.offsetWidth },
                  }),
                  Sr(Cn, Mr.value),
                  (s.current = !1));
              };
                  ...
                  children: bn('div', {
                    ...
                    children: [
                      ...
                      Xr.value.query
                        ...
                        : !!c.length &&
                          bn('span', { className: 'text-xs text-neutral-500', children: c.length }),
                    ],
                  }),
                }),
                bn('div', {
          ...
          bn('div', {
            ...
            children: [
              ...
              !r &&
                bn('span', {
                  className: 'truncate',
                  children: e instanceof Date ? Ho(e) : `{${Object.keys(e).join(', ')}}`,
                }),
            ],
          }),
          r &&
              ...
              children: [
                ...
                t &&
                  bn('div', {
                    ...
                    children: o.map((e, t) =>
                      bn(ro, { value: e, path: t.toString(), isNegative: r }, t.toString())
                    ),
                  }),
                bn(to, {
                  text: Oo(o),
                  className:
                    'absolute top-0.5 right-0.5 opacity-0 transition-opacity group-hover:opacity-100 self-end',
                  ...
                  children: t
                    ? bn('div', {
                        ...
                        children: Object.entries(o).map(([e, t]) =>
                          bn(ro, { value: t, path: e, isNegative: r }, e)
                        ),
                      })
    ...
    co = (e, t) => {
      ...
      return {
        contextChanges: n,
        propsChanges: lo(e.propsChanges, t.propsChanges),
        stateChanges: lo(e.stateChanges, t.stateChanges),
      };
    },
    uo = (e) =>
              ...
              return (
                ...
                () => {
                  (n({
                    ...
                    (e.current.queue = []),
                    wl.changesListeners.set(
                      o,
                      wl.changesListeners.get(o)?.filter((e) => e !== t) ?? []
                    ));
                }
              );
            }, [o]),
                  ...
                  children: [
                    bn('span', {
                      ...
                      children: [
                        'Why did',
                        ' ',
                        bn('span', { className: 'text-[#A855F7]', children: F(s) }),
                        ' ',
                        'render?',
                      ],
                    }),
                    !i &&
                      bn('div', {
                        className:
                          'text-sm text-[#737373] bg-[#1E1E1E] rounded-md p-4 flex flex-col gap-4',
                        children: [
      ...
      return bn('span', {
        ...
        children: [
          ...
          bn('span', {
            ...
            children: [
              'called in ',
              bn('i', { className: 'text-[#A855F7] truncate', children: t }),
            ],
          }),
        ],
      });
      ...
      return (
        Xe(() => {
          const o = _r(() => {
            ...
            for (const e of r)
              (e.classList.remove('count-flash-white'),
                e.offsetWidth,
                e.classList.add('count-flash-white'));
          }, 400);
          return Lr.subscribe((i) => {
            ...
            l &&
              ...
              'true' !== e.current.dataset.flash &&
                (e.current.dataset.flash = r.current.isPropsChanged.toString()),
              'true' !== t.current.dataset.flash &&
                (t.current.dataset.flash = r.current.isStateChanged.toString()),
              'true' !== n.current.dataset.flash &&
                (n.current.dataset.flash = r.current.isContextChanged.toString()));
          });
        }, []),
        bn('button', {
          type: 'button',
    ...
    xo = ({ prevValue: e, currValue: t, entryKey: n, expandedFns: r, setExpandedFns: o }) =>
      bn(fe, {
        children: [
          bn('div', {
            className:
              'group flex gap-0.5 items-start text-[#f87171] bg-[#2a1515] py-[3px] px-1.5 rounded',
            children: [
              bn('span', {
                className: 'w-3 flex items-center justify-center opacity-50',
                children: '-',
          ...
          bn('div', {
            className:
              'group flex gap-0.5 items-start text-[#4ade80] bg-[#1a2a1a] py-[3px] px-1.5 rounded mt-0.5',
            children: [
              bn('span', {
                className: 'w-3 flex items-center justify-center opacity-50',
                children: '+',
    ...
    So = jr(() => {
      ...
      return (
        Mt(() => {
          ...
          lt(() => {
            if ('focused' !== n.kind || !n.focusedDomElement)
              return ((e.current = null), void ko.cleanup());
            ...
            lt(() => {
              ...
              (t(r),
                n.focusedDomElement.isConnected ||
                  ((e.current = null),
                  ko.cleanup(),
                  (wl.inspectState.value = { kind: 'inspecting', hoveredDomElement: null })));
            }));
        }),
        Xe(
          () => () => {
        ...
        bn(_o, {
          children: bn('div', {
            className: No,
            children: bn('div', { className: 'w-full h-full', children: bn(ho, {}) }),
          }),
        })
      );
    }),
    ...
    Lo = (e, t, n = [], r = new WeakSet()) => {
      ...
      if ('function' == typeof e && 'function' == typeof t) {
        const r = ((e, t) => {
          try {
            return (
              'function' == typeof e && 'function' == typeof t && e.toString() === t.toString()
            );
          } catch {
            return !1;
          }
        ...
        return {
          type: 'primitive',
          changes: [{ path: n, prevValue: e, currentValue: t, sameFunction: r }],
          hasDeepChanges: !r,
        };
      }
      if (
    ...
    Uo = (e) =>
      0 === e.length
        ? ''
        : e.reduce((e, t, n) => (/^\d+$/.test(t) ? `${e}[${t}]` : 0 === n ? t : `${e}.${t}`), '');
  var Wo = (e, t = !1) => {
      try {
        const n = e.toString(),
    ...
    ti = (e) => {
      ...
      if (0 === e.tag || 11 === e.tag || 15 === e.tag || 14 === e.tag) {
        ...
        let r = 0;
        for (; t; )
          (t.queue && void 0 !== t.memoizedState && (n[r] = t.memoizedState), (t = t.next), r++);
        return n;
      }
    ...
    ni = (e) => {
      ...
      return {
        current: r,
        prev: o,
        changes: Po(e).map((e) => ({ name: e.name, value: e.value, prevValue: e.prevValue })),
      };
    },
    ri = (e) => {
      const t = ti(e),
    ...
    oi = (e) => {
      ...
      for (const [e, s] of t) {
        ...
        c &&
          ((o[t] = c.value),
          Dt(c.value, s.value) ||
            i.push({ name: t, value: s.value, prevValue: c.value, contextType: e }));
      }
    ...
    ii = (e) => {
      ...
      if (!e)
        return { data: { fiberProps: t(), fiberState: t(), fiberContext: t() }, shouldUpdate: !1 };
      let n = !1;
      const r = ((e) => {
          const t = e.type !== Go;
          return ((Go = e.type), t);
      ...
      if (e.memoizedProps) {
        ...
        for (const [e, n] of Object.entries(t))
          o.current.push({
            name: e,
            value: Vo(n) ? { type: 'promise', displayValue: 'Promise' } : n,
          });
        for (const e of r) {
    ...
    li = (e) => {
      ...
      if (e.memoizedProps) {
        ...
        for (const [e, r] of Object.entries(t))
          n.current.push({
            name: e,
            value: Vo(r) ? { type: 'promise', displayValue: 'Promise' } : r,
          });
      ...
      for (const [e, t] of Object.entries(i))
        o.current.push({
          name: e,
          value: Vo(t) ? { type: 'promise', displayValue: 'Promise' } : t,
        });
      ...
      return (
        ((e, t) => {
          try {
            ...
            for (
              ;
              (o && 'object' == typeof o && 'memoizedValue' in o) ||
              (i && 'object' == typeof i && 'memoizedValue' in i);
            ) {
              if (!0 === t(o, i)) return !0;
              ((o = o?.next), (i = i?.next));
            }
                  ...
                  u =
                    ((e) => {
                      ...
                      for (; n.length; ) {
                        const e = n.pop();
                        e &&
                          (_(e) && C(e) && S(e) && t.push(e),
                          e.child && n.push(e.child),
  ...
  function Xi(e, t) {
    ...
    (n.length > 0 && this.resolveNext && (this.resolveNext(n), (this.resolveNext = null)),
      this.seenElements.size === this.uniqueElements.size &&
        (t.disconnect(), (this.done = !0), this.resolveNext && this.resolveNext([])));
  }
  var Bi,
    qi,
    Ji,
      ...
      for (const t of Hi) {
        ...
        if (n)
          for (let t = 0; t < n.elements.length; t++)
            n.elements[t] instanceof Element && e.push(n.elements[t]);
      }
      const t = new Map();
          ...
          if (a.has(t))
            for (const [r, o] of a.entries()) {
              ...
              i + l > d &&
                ...
                s + c > u &&
                u + h > s &&
                ((n.text = Fi(n.outlines.concat(o.outlines))),
            ...
            n = ((e) => {
              ...
              if (1 === e.tag) {
                const n = {
                  ...
                  prevValue: e.alternate?.memoizedState,
                };
              ...
              const t = (() => {
                ...
                if (((n.width = i), (n.height = a), ea && !window.__REACT_SCAN_EXTENSION__))
                  try {
                    ...
                    ji?.postMessage(
                      { type: 'init', canvas: e, width: n.width, height: n.height, dpr: Oi },
                      [e]
                    );
                  } catch (e) {
                    ...
                    setTimeout(() => {
                      ...
                      ((Oi = ta()),
                        ...
                        ji
                          ...
                          : ((n.width = e * Oi),
                            (n.height = t * Oi),
                            Ii && (Ii.resetTransform(), Ii.scale(Oi, Oi)),
                            Qi()),
                        (s = !1));
                    }));
                });
        ...
        o = Ti('react-scan-devtools-0.1.0', {
          ...
          onActive: () => {
            na() ||
              ...
              window.__REACT_SCAN_EXTENSION__ ||
                (globalThis.__REACT_SCAN__ = { ReactScanInternals: vl }),
              clearInterval(Bi),
              (Bi = setInterval(() => {
          ...
          onRender: (e, t) => {
            ...
            const n = vl.instrumentation?.isPaused.value,
              r =
                'inspect-off' === wl.inspectState.value.kind ||
                'uninitialized' === wl.inspectState.value.kind;
            (n && r) ||
              (n || Yi(e),
              vl.options.value.log &&
                ((e) => {
                  ...
                  for (let n = 0, r = e.length; n < r; n++) {
                    ...
                    (a && s && o.push({ prev: a, next: s, type: 'props', unstable: !1 }),
                      t.set(i, o));
                  }
      ...
      (Mt(() => {
        ...
        Mt(() => {
          ...
          lt(() => {
            ...
            ((e.current.dataset.text = c ? ` • ${c}` : ''),
              (t.current.dataset.text = d ? ` • ${d}` : ''));
          });
        }));
      const o = Je(() => {
        if (!n) return null;
        ...
        return bn('div', {
          ...
          children: [
            bn('div', {
              ...
              children: bn('div', {
                className: kr('react-scan-header-item is-visible', !e && '!duration-0'),
                children: bn(ca, {}),
              }),
            }),
            bn('button', {
    ...
    ua = ({ className: e, ...t }) =>
      bn('div', {
        className: kr('react-scan-toggle', e),
        children: [bn('input', { type: 'checkbox', ...t }), bn('div', {})],
      }),
    pa = ({ fps: e }) => {
      return bn('div', {
        className: kr(
        ...
        children: [
          bn('div', {
            style: {
              color: ((t = e), t < 30 ? '#EF4444' : t < 50 ? '#F59E0B' : 'rgb(214,132,245)'),
            },
            className:
    ...
    ((e, t, i, s) => {
      if ((t && 'object' == typeof t) || 'function' == typeof t)
        for (let l of o(t))
          a.call(e, l) ||
            l === i ||
            n(e, l, { get: () => t[l], enumerable: !(s = r(t, l)) || s.enumerable });
    })(qi && qi.__esModule ? Ji : n(Ji, 'default', { value: qi, enumerable: !0 }), qi));
  var ma,
    fa = () =>
      ae
        ? (void 0 === window.reactScanIdCounter && (window.reactScanIdCounter = 0),
    ...
    xa = new (class {
      ...
      publish(e, t, n = !0) {
        ...
        if (!r) {
          if (!n) return;
          return (
            (this.channels[t] = { callbacks: new wa(ba), state: new wa(ba) }),
      ...
      subscribe(e, t, n = !1) {
        ...
        return o
          ...
          : ((this.channels[e] = { callbacks: new wa(ba), state: new wa(ba) }),
    ...
    Ra = (e, t) => {
      ...
      const r = (t) => {
        ...
        i = (n) => {
          if (
            n.composedPath().some((e) => e instanceof Element && 'react-scan-toolbar-root' === e.id)
          )
            return;
          if (
              ...
              onRAF: () =>
                'js-end-stage' !== o.current.kind && 'raf-stage' !== o.current.kind
                  ? (t?.onError?.(o.current.interactionUUID),
                    ...
                    !1)
                  : ((o.current = { ...o.current, kind: 'raf-stage', rafStart: performance.now() }),
                    !0),
              onTimeout: () => {
      ...
      return (
        ...
        () => {
          (document.removeEventListener(r({ phase: 'start' }), i, { capture: !0 }),
      ...
      const t = (t) => {
        ...
        if (!r) {
          ...
          const { selfTime: a, totalTime: s } = E(t),
            ...
            d = {
              fiberProps: l.fiberProps || c,
              fiberState: l.fiberState || c,
              fiberContext: l.fiberContext || c,
            };
          return void (e[n] = {
            renderCount: 1,
            hasMemoCache: A(t),
        ...
        ((r.wasFiberRenderMount = r.wasFiberRenderMount || Ia(t)),
          ...
          r.nodeInfo.push({
            element: $a(t),
            name: F(t.type) ?? 'Unknown',
            selfTime: E(t).selfTime,
          }));
      };
      return (
    ...
    Ia = (e) => {
      ...
      const t = e.alternate,
        n =
          ...
          null != t.memoizedState.element &&
          !0 !== t.memoizedState.isDehydrated,
        r =
          null != e.memoizedState &&
          null != e.memoizedState.element &&
          !0 !== e.memoizedState.isDehydrated;
      return !n && r;
    },
    Oa = (e) => {
      let t;
      const n = new Set(),
        r = (e, r) => {
          ...
          if (!Object.is(o, t)) {
            const e = t;
            ((t = (r ?? ('object' != typeof o || null === o)) ? o : Object.assign({}, t, o)),
              n.forEach((n) => n(t, e)));
          }
        },
        o = () => t,
  ...
  var Ja = () => {
      const e = Ea((e) => {
                  ...
                  if (
                    ...
                    Ha.getState().actions.addEvent({
                      ...
                      data: {
                        endAt: n,
                        startAt: r,
                        meta: { fiberRenders: Ua, latency: t, fps: l },
                      },
                    });
                  }
                  ((Va = null), (Xa = null), r?.(), n());
        ...
        o = async (e, t, n) => {
          ...
          (t.detailedTiming.stopListeningForRenders(),
            r.length && xa.updateChannelState('recording', () => new wa(ba)));
        },
    ...
    cs = ({ className: e = '', size: t = 24 }) =>
      bn('svg', {
        ...
        children: [
          bn('circle', { cx: '12', cy: '12', r: '10' }),
          bn('path', { d: 'm4.9 4.9 14.2 14.2' }),
        ],
      }),
    ds = ({ className: e = '', size: t = 24 }) =>
      bn('svg', {
        ...
        className: e,
        children: [
          bn('polyline', { points: '22 17 13.5 8.5 8.5 13.5 2 7' }),
          bn('polyline', { points: '16 17 22 17 22 11' }),
        ],
      }),
                ...
                'div',
                {
                  ...
                  children: [
                    bn('button', {
                      onClick: () =>
                        o((e) =>
                          e.includes(t.kind) ? e.filter((e) => e !== t.kind) : [...e, t.kind]
                        ),
                      className:
    ...
    ws = (e) => {
      ...
      return t > 100
        ? {
            ...
            data: { count: t, percentageOfTotal: (n / r) * 100, copyButton: bn(vs, {}) },
          }
    ...
    vs = () => {
      ...
      return bn('button', {
        onClick: async () => {
          n.selectedEvent &&
            (await navigator.clipboard.writeText(ms('explanation', n.selectedEvent)),
            t(!0),
            setTimeout(() => t(!1), 1e3));
        },
          ...
          switch (
            ...
            case 'transition':
              if (t.current && t.current.alpha > 0)
                return ((t.current.alpha = Math.max(0, t.current.alpha - 0.03)), void Cs());
              if (1 === t.transitionTo.alpha)
                return void (Ns.value = { kind: 'idle', current: t.transitionTo });
  ...
  var Es,
      ...
      e &&
        ('transition' !== Ns.value.kind
          ...
          : (Ns.value = {
              kind: 'move-out',
              current:
                0 === Ns.value.current?.alpha
                  ? Ns.value.transitionTo
                  : (Ns.value.current ?? Ns.value.transitionTo),
            }));
    },
    Ms = ({ selectedEvent: e }) => {
      const t = Ka(e.timing),
        ...
        [r] = Ve(Sl()),
        o = e.groupedFiberRenders.map((e) => ({
          event: e,
          kind: 'render',
          totalTime: r ? e.count : e.totalTime,
        })),
        i = ga(() => {
          switch (e.kind) {
            case 'dropped-frames':
      ...
      ('interaction' !== e.kind ||
        r ||
        o.push({ kind: 'other-javascript', totalTime: e.timing.otherJSTime }),
        i &&
          !r &&
          ('interaction' === e.kind
            ? o.push({
                kind: 'other-not-javascript',
                totalTime: Ka(e.timing) - e.timing.renderTime - e.timing.otherJSTime,
              })
      ...
      const { setNotificationState: a, setRoute: s } = Qa(),
        ...
        u = o.filter(
          (t) =>
            'render' === t.kind &&
            'render' === e.kind &&
            e.event.parents.has(t.event.name) &&
            t.event.name !== e.event.name
        ),
        p =
          'render' === e.kind
            ? Array.from(e.event.parents).filter(
                (e) => !o.some((t) => 'render' === t.kind && t.event.name === e)
              )
            : [];
      return bn('div', {
        className: 'w-full',
          ...
          bn('div', {
            ...
            children: [
              bn('button', {
                ...
                onMouseEnter: async () => {
                  const n = async () => {
                    ...
                    if ('transition' === n.kind) {
                      const t = ((e) =>
                        e.current && e.current.alpha > 0 ? 'fading-out' : 'fading-in')(n);
                      ga(() => {
                        switch (t) {
                          case 'fading-in':
                ...
                onClick: () => {
                  'render' === e.kind
                    ? (a((t) => ({ ...t, selectedFiber: e.event })),
                      s({ route: 'render-explanation', routeMessage: null }))
                    : s({
                        route: 'other-visualization',
                        routeMessage: { kind: 'auto-open-overview-accordion', name: e.kind },
                      });
                },
                className: kr([
                      ...
                      children: bn('div', {
                        ...
                        children: bn('div', {
                          ...
                          children: [
                            bn('div', {
                              className:
                                'flex items-center rounded-sm text-white text-xs h-[28px] w-full',
                            }),
                            bn('div', {
    ...
    Rs = ({ selectedEvent: e, selectedFiber: t }) => {
      ...
      Be(() => {
        ...
        if (null === t)
          return (o(!0), void localStorage.setItem('react-scan-tip-is-shown', 'true'));
        t || o(!1);
      }, []);
      const a =
                ...
                children: [
                  ...
                  bn('div', {
                    ...
                    children: [
                      ...
                      bn('div', {
                        className: kr(['text-xs text-gray-400 mb-4']),
    ...
    $s = () => {
                  ...
                  bn('button', {
                    onClick: () => {
                      ...
                      (It(n),
                        t((e) => ({
                          ...e,
                          audioNotificationsOptions: { enabled: !0, audioContext: n },
                        })));
                    },
                    className: kr([
      ...
      switch (e.route) {
        ...
        case 'render-explanation':
          ...
          return bn(Ps, {
            children: bn(Rs, { selectedFiber: e.selectedFiber, selectedEvent: e.selectedEvent }),
          });
    ...
    Ps = ({ children: e }) => {
      ...
      return bn('div', {
        ...
        children: [
          bn('div', {
            className: kr(['h-[50px] w-full']),
            children: bn(ps, { selectedEvent: t.selectedEvent }),
          }),
          bn('div', {
            className: kr(['h-calc(100%-50px) flex flex-col overflow-y-auto px-3']),
            children: e,
          }),
        ],
      });
    ...
    Ds = ({ item: e, shouldFlash: t }) => {
      const [n, r] = Ve(!1),
        ...
        i = (({ flashingItemsCount: e, totalEvents: t }) => {
          ...
          flashingItemsCount: e.events.reduce((e, n) => (t(n.id) ? e + 1 : e), 0),
              ...
              bn('div', {
                ...
                children: [
                  ...
                  bn('span', {
                    className: kr(['text-xs']),
                    children:
                      'collapsed-frame-drops' === e.kind
                        ? 'FPS Drops'
                        : Ga(e.events.at(0)?.componentPath ?? []),
                  }),
                ],
              }),
              bn('div', {
          ...
          n &&
            bn(Is, {
              children: e.events
                ...
                .map((e) => bn(Os, { event: e, shouldFlash: t(e.id) })),
            }),
        ],
      });
    },
            ...
            children: [
              bn('div', {
                ...
                children: [
                  ...
                  bn('span', {
                    className: kr(['text-xs pr-1 truncate']),
                    children: Ga(e.componentPath),
                  }),
                ],
              }),
              bn('div', {
        ...
        children: [
          bn('div', {
            ...
            children: [
              ...
              bn(us, {
                ...
                children: bn('div', {
                  className: kr(['w-full flex justify-center']),
          ...
          bn('div', {
            ...
            children: [
              0 === i.length &&
                bn('div', {
                  className: kr(['flex items-center justify-center text-zinc-500 text-sm py-4']),
                  children: 'No Events',
                }),
              i.map((e) =>
                ga(() => {
          ...
          switch (e.kind) {
            case 'interaction': {
              ...
              return void t.push({
                ...
                type:
                  'keyboard' === e.data.meta.detailedTiming.interactionType ? 'keyboard' : 'click',
                timing: {
                  renderTime: r,
                  kind: 'interaction',
                  otherJSTime: l,
    ...
    Hs = () => {
      ...
      return (
        Xe(() => {
          ...
          if ('false' !== e && 'true' !== e)
            return void localStorage.setItem('react-scan-notifications-audio', 'false');
          'false' !== e &&
            t((e) =>
              e.audioNotificationsOptions.enabled
                ? e
                : {
                    ...e,
                    audioNotificationsOptions: { enabled: !0, audioContext: new AudioContext() },
                  }
            );
        }, []),
        Xe(() => {
        ...
        children: [
          n.selectedEvent &&
            bn('div', {
              ...
              children: [
                bn(js, { selectedEvent: n.selectedEvent }),
                n.moreInfoExpanded && bn(Xs, {}),
              ],
            }),
          bn('div', {
            className: kr([
            ...
            children: [
              ...
              bn('div', {
                className: kr(['w-[calc(100%-200px)] h-full overflow-y-auto']),
                children: bn($s, {}),
              }),
            ],
          }),
        ...
        l = Ge(() => {
          switch (wl.inspectState.value.kind) {
            case 'inspecting':
              return (
                (Rr.value = { view: 'none' }),
                void (wl.inspectState.value = { kind: 'inspect-off' })
              );
            case 'focused':
              return (
            ...
            bn('div', {
              ...
              children: bn('button', {
                ...
                children: bn(ns, {
                  ...
                  className: kr([
                    'text-[#999]',
                    'notifications' === Rr.value.view && 'text-[#8E61E3]',
                  ]),
                }),
              }),
            }),
          ...
          bn('div', {
            ...
            children: [
              ...
              bn('div', {
                ...
                children: [
                  bn(Qs, { isOpen: Gs, children: bn(Co, {}) }),
                  bn(Qs, { isOpen: Ks, children: bn(Ys, {}) }),
                ],
              }),
            ],
          }),
    ...
    al = (e, t, n) => {
      ...
      return (
        a &&
          ((c = r ? Math.min(-24, Math.max(c, -p)) : Math.max(u, Math.min(c, p))),
          (d = Math.max(24, Math.min(d, h)))),
        { x: c, y: d }
      );
    },
    sl = (e, t, n) => {
    ...
    ll = ({ position: e }) => {
            ...
            const t = 'focused' === wl.inspectState.value.kind,
              ...
              r =
                ...
                ((e, t, n, r) =>
                  ...
                  e,
                  Mr.value.corner,
                  Mr.value.dimensions.isFullWidth,
                  Mr.value.dimensions.isFullHeight
                );
            r
      ...
      const i = Ge((t) => {
          ...
          (document.addEventListener('pointermove', u, { passive: !0 }),
        ...
        a = Ge((t) => {
          ...
          const m = al(h, u, p),
            ...
            b = s
              ? Sn
              : ('left' !== e && 'right' !== e) || s
                ? Math.min(g, Math.max(Sn, w))
                : Math.min(g, Math.max(Sn, v));
          (requestAnimationFrame(() => {
            ((Mr.value = {
              corner: h,
              dimensions: f,
              lastDimensions: o,
              componentsTree: { ...Mr.value.componentsTree, width: b },
            }),
    ...
    dl = () => {
        ...
        i = Ge((i = !0) => {
          ...
          (u.addEventListener('transitionend', m),
            ...
            (h = requestAnimationFrame(() => {
              ((p.width = `${s}px`),
                (p.height = `${l}px`),
                (p.transform = `translate3d(${c.x}px, ${c.y}px, 0)`),
                (h = null));
            })));
          const f = {
                  ...
                  if (N) {
                    ...
                    ((s = Math.max(v, b) > Math.max(x, y) ? 'horizontal' : 'vertical'),
                      (Mr.value = {
                        ...Mr.value,
                        corner: a,
                        lastDimensions: { ...o, position: al(a, o.width, o.height) },
                      }));
          ...
          const c = (t) => {
              ...
              if (
                ('horizontal' === o
                  ...
                  : ((r.startsWith('top') && p > 50) || (r.startsWith('bottom') && p < -50)) &&
                    (h = !0),
                h)
              ) {
                  ...
                  requestAnimationFrame(() => {
                    if (e.current) {
                      ...
                      ((l = Math.max(yn, Math.min(l, window.innerWidth - a - yn))),
                        ...
                        (Mr.value = {
                          ...Mr.value,
                          dimensions: { ...Mr.value.dimensions, position: { x: l, y: c } },
                        }),
                        i(!0));
                      const d = Nr(zn);
      ...
      Xe(() => {
        ...
        const a = Mr.subscribe((t) => {
          ...
          s = Rr.subscribe((e) => {
            ((t.current = 'none' !== e.view),
              i(),
              $r.value || ('none' !== e.view ? Sr(zn, e) : Cr(zn)));
          }),
        ...
        return (
          ...
          () => {
            (window.removeEventListener('resize', c),
              ...
              l(),
              a(),
              Sr(Cn, { ...Ar, corner: Mr.value.corner }));
          }
        );
      }, []);
      const [l, c] = Ve(!1);
              ...
              children: d
                ? bn('button', {
                    ...
                    children: bn(xn, {
                      name: 'icon-chevron-right',
                      size: 16,
                      className: kr('transition-transform', u),
                    }),
                  })
                : bn(fe, {
                    children: [
      ...
      bn('svg', {
        ...
        children: [
          ...
          bn('symbol', {
            ...
            'stroke-linejoin': 'round',
            children: [
              bn('line', { x1: '18', y1: '6', x2: '6', y2: '18' }),
              bn('line', { x1: '6', y1: '6', x2: '18', y2: '18' }),
            ],
          }),
          bn('symbol', {
            id: 'icon-replay',
          ...
          bn('symbol', {
            ...
            'stroke-linejoin': 'round',
            children: [
              bn('circle', { cx: '11', cy: '11', r: '8' }),
              bn('line', { x1: '21', y1: '21', x2: '16.65', y2: '16.65' }),
            ],
          }),
          bn('symbol', {
            id: 'icon-lock',
  ...
  var xl,
        ...
        switch (r) {
          ...
          case 'animationSpeed':
            ['slow', 'fast', 'off'].includes(o)
              ? (n[r] = o)
              : t.push(`- Invalid animation speed "${o}". Using default "fast"`);
            break;
          case 'onCommitStart':
            'function' != typeof o
    ...
    Cl = () => {
      try {
        if (!ae) return;
        if (!vl.runInAllEnvironments && Sl() && !vl.options.value.dangerouslyForceRunInProduction)
          return;
    ...
    Tl = (e) => {
      ...
      const { shadowRoot: o } = (() => {
        ...
        (((fl = document.createElement('div')).id = 'react-scan-root'),
          (gl = fl.attachShadow({ mode: 'open' })));
      ...
      ((e) => {
        ...
        t.remove = () => {
          ((window.__REACT_SCAN_TOOLBAR_CONTAINER__ = void 0),
            t.hasChildNodes() && (Re(null, t), Re(null, t)),
            n());
        };
      })(o);
    },
    zl = () => {
      try {
        return ((e) => {
          if (((ks = document.createElement('canvas')), !(_s = ks.getContext('2d', { alpha: !0 }))))
            return null;
